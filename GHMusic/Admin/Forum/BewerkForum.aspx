<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BewerkForum.aspx.cs" Inherits="GHMusic.Admin.Forum.BewerkForum" %>
<%@ MasterType VirtualPath="~/Site.Master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>"<asp:Literal ID="lblForumName" runat="server" />" bewerken</h1>
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td class="auto-style6">
                <asp:DropDownList ID="ddParentForumID" runat="server" DataSourceID="SqlDataSource1" DataTextField="NAAM" DataValueField="FORUMID" AppendDataBoundItems="true" >
                    <asp:ListItem Text="--Geen parents--" Value="0" />
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
